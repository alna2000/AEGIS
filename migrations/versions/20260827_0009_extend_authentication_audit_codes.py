"""Extend controlled authentication audit event codes.
...
def upgrade() -> None:
    """Allow only the two reviewed Part 2 event codes in addition to Part 1."""

    _replace_event_code_constraint(_PART_2_CODES)


def downgrade() -> None:
    """Restore the exact Part 1 controlled event-code vocabulary."""

    _replace_event_code_constraint(_PART_1_CODES)
